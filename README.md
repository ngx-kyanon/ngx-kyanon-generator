# :kyanon: ngx-kyanon-generator

[![NPM version](https://img.shields.io/npm/v/ngx-kyanon-generator.svg)](https://www.npmjs.com/package/ngx-kyanon-generator)
[![Build Status](https://sinedied.visualstudio.com/oss-pipelines/_apis/build/status/ngx-kyanon.ngx-kyanon-generator?branchName=master)](https://sinedied.visualstudio.com/oss-pipelines/_build/latest?definitionId=2&branchName=master&WT.mc_id=generatorngxkyanon-github-yolasors)
![Node version](https://img.shields.io/node/v/ngx-kyanon-generator.svg)
[![XO code style](https://img.shields.io/badge/code_style-XO-5ed9c7.svg)](https://github.com/sindresorhus/xo)
[![Downloads](https://img.shields.io/npm/dt/ngx-kyanon-generator.svg)](https://npmjs.org/package/ngx-kyanon-generator)

![ngx-kyanon logo](https://kyanon.digital/images/logo.png)
...
See generated project example [here](https://github.com/ngx-kyanon/starter-kit).
...
- **Generator output customization:** with the provided
  [add-on support](https://github.com/ngx-kyanon/ngx-kyanon-generator/tree/master/generators/addon), start multiple
...
## Using [ngx-kyanon CLI](https://github.com/ngx-kyanon/ngx-kyanon-generator/tree/master/cli)
...
> Take a look at the [full documentation](https://github.com/ngx-kyanon/ngx-kyanon-generator/tree/master/cli)!
...
- [Angular](https://github.com/ngx-kyanon/starter-kit/blob/master/docs/coding-guides/angular.md)
- [Ionic](https://github.com/ngx-kyanon/starter-kit/blob/cordova/ionic/docs/coding-guides/ionic.md)
- [TypeScript](https://github.com/ngx-kyanon/starter-kit/blob/master/docs/coding-guides/typescript.md)
- [Sass](https://github.com/ngx-kyanon/starter-kit/blob/master/docs/coding-guides/sass.md)
- [HTML](https://github.com/ngx-kyanon/starter-kit/blob/master/docs/coding-guides/html.md)
- [Unit tests](https://github.com/ngx-kyanon/starter-kit/blob/master/docs/coding-guides/unit-tests.md)
- [End-to-end tests](https://github.com/ngx-kyanon/starter-kit/blob/master/docs/coding-guides/e2e-tests.md)

#### Other documentation

- [I18n guide](https://github.com/ngx-kyanon/starter-kit/blob/master/docs/i18n.md)
- [Working behind a corporate proxy](https://github.com/ngx-kyanon/starter-kit/blob/master/docs/corporate-proxy.md)
- [Updating dependencies and tools](https://github.com/ngx-kyanon/starter-kit/blob/master/docs/updating.md)
- [Using a backend proxy for development](https://github.com/ngx-kyanon/starter-kit/blob/master/docs/backend-proxy.md)
- [Browser routing](https://github.com/ngx-kyanon/starter-kit/blob/master/docs/routing.md)
- [Cordova](https://github.com/ngx-kyanon/starter-kit/blob/cordova/ionic/docs/cordova.md)
- [Electron](https://github.com/ngx-kyanon/starter-kit/blob/electron/ionic/docs/electron.md)
...
- `--automate <json_file>`: automate prompt answers using specified JSON file (see
  [here](https://github.com/ngx-kyanon/ngx-kyanon-generator/tree/master/scripts/tests) for examples).
...
[add-ons](https://www.npmjs.com/search?q=ngx-kyanon-addon).

To create a new add-on, you can use the `addon` sub-generator of the [CLI](https://github.com/ngx-kyanon/ngx-kyanon-generator/tree/master/cli):
```sh
ngx new --addon
```

See the [add-on generator documentation](https://github.com/ngx-kyanon/ngx-kyanon-generator/tree/master/generators/addon)
